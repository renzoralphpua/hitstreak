...
const field =
  "h-11 w-full rounded-tile border border-hairline bg-surface px-3.5 text-ink outline-none focus:border-ink placeholder:text-dim";
...
export default function Input({ label, className, ...rest }: Props) {
  const input = <input className={cn(field, className)} {...rest} />;

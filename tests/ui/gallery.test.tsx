...
describe("/dev/ui gallery", () => {
  it("renders a section for every primitive", () => {
    render(<Gallery />);
    for (const n of ["Button", "Pill", "Panel", "SectionHeading", "StatTile", "PriceDelta", "ProgressBar", "TierBadge", "ValidationList", "SearchField", "CardTile", "CardRow", "TopNav", "BottomTabBar", "ThemeToggle", "MoneyDisplay", "EmptyState"]) {
